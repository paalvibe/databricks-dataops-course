...
# MAGIC
# MAGIC Go to `orgs/acme/domains/transport/projects/taxinyc/flows/prep/revenue/explore/taxinyc_revenue`. Connect to the UC Shared Cluster you have been assigned, and run through the cells.
