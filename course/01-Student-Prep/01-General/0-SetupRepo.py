...
# MAGIC 2. Setup Databricks/repo to be able to receive commits from Databricks, by approving the Databricks app, and getting approved by repo owner. Send him your github username.
# MAGIC     - (Possible alternative: Fork the repo to your own github account)
